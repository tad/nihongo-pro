...
- **Video-Study sync** — optionally push your known words & kanji to the companion **Video-Study** Chrome extension (for studying Japanese on Netflix). Enter your Cloudflare Worker URL and a shared secret in Settings → *Video-Study Sync*; thereafter every familiarity change is pushed automatically (and once on launch). One-way — Nihongo Pro is the source of truth.
