...
- **Look up in Nihongo** — every word and kanji modal includes a small *Look up in Nihongo* button that opens the word or kanji directly in [Nihongo - Japanese Dictionary](https://apps.apple.com/us/app/nihongo-japanese-dictionary/id881697245) (if installed) via universal link, or falls back to the web dictionary page otherwise. Useful for richer definitions, example sentences, and flashcard export.
